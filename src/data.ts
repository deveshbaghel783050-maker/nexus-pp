    ...
    customizations: [
      {
        ...
        options: [
          ...
          { name: 'pp Red Fiery (Sichuan Style)', price: 0 },
        ]
      }
    ]
  },
...
export const MOKAI_GALLERY_SPACES = [
  {
    ...
    spots: [
      { x: 25, y: 35, title: 'Experience pp Wall', txt: 'Curated signage detailing Mokai’s journey from a humble local dream to a Mumbai coffee sanctuary.' },
